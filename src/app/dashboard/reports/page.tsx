  ...
  return (
    ...
    >
      <div>
        ...
        <p className="mt-2 text-sm text-zinc-400 leading-relaxed">{report.description}</p>
      </div>
    </Link>
  );
}
  ...
  return (
    ...
    >
      <div>
        ...
        <p className="mt-2 text-sm text-zinc-500 leading-relaxed">{report.description}</p>
        {report.soonReason && (
          <p className="mt-2 text-[11px] text-zinc-600">{report.soonReason}</p>
        )}
      </div>
    </div>
  );
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div className="min-w-0">
          <p className="text-[10px] uppercase tracking-[0.15em] text-zinc-500 mb-2">Reports</p>
          <h1
          ...
          <p className="mt-2 max-w-2xl text-sm text-zinc-400">
            {readyCount} live reports across finance, sales, inventory and more — every figure in DA,
      ...
      {hasResults ? (
        ...
        <div className="rounded-xl border border-white/10 bg-zinc-900/50 py-16 text-center">
          <p className="text-sm font-bold text-white">No reports match “{query}”</p>
