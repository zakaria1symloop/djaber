...
export const ArrowUpIcon = ({ className = 'w-5 h-5' }: IconProps) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 10l7-7m0 0l7 7m-7-7v18" />
  </svg>
);

export const ArrowDownIcon = ({ className = 'w-5 h-5' }: IconProps) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const LayersIcon = ({ className = 'w-5 h-5' }: IconProps) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const BotIcon = ({ className = 'w-5 h-5' }: IconProps) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714a2.25 2.25 0 00.659 1.591L19 14.5M14.25 3.104c.251.023.501.05.75.082M19 14.5a2.25 2.25 0 00.75-1.661V8.706c0-.248-.034-.495-.1-.736M19 14.5l-1.5 1.5M5 14.5a2.25 2.25 0 01-.75-1.661V8.706c0-.248.034-.495.1-.736M5 14.5l1.5 1.5m0 0l.75.75M6.5 16l-.75.75M17.5 16l.75.75M17.5 16l-.75.75M12 21a2.25 2.25 0 002.25-2.25V17.5m-4.5 0v1.25A2.25 2.25 0 0012 21m0 0a2.25 2.25 0 002.25-2.25M12 21a2.25 2.25 0 01-2.25-2.25" />
  </svg>
);
...
export const CalculatorIcon = ({ className = 'w-5 h-5' }: IconProps) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
